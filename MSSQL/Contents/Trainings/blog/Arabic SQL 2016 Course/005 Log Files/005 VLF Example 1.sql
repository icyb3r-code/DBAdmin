...
CREATE DATABASE GoodVLF
 ON  PRIMARY 
( NAME = N'GoodVLF', FILENAME = N'E:\MSSQL\Data\GoodVLF.mdf' , SIZE = 4096KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'GoodVLF_log', FILENAME = N'E:\MSSQL\Logs\GoodVLF_log.ldf' , SIZE = 800MB , FILEGROWTH = 100MB)
GO
---  CPU time = 16 ms,  elapsed time = 3816 ms.
...
CREATE DATABASE BadVLF
 ON  PRIMARY 
( NAME = N'BadVLF', FILENAME = N'E:\MSSQL\Data\BadVLF.mdf' , SIZE = 4096KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BadVLF_log', FILENAME = N'E:\MSSQL\Logs\BadVLF_log.ldf' , SIZE = 1MB , FILEGROWTH = 10%)
GO
